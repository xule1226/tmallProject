...
$(function () {
  ...
  $('.fix-left li').click(function () {
    ...
    $('html,body').stop().animate({
      'scrollTop': $('.gunlun>div').eq(index - 1).offset().top - 300
    }, 800);
  });
  ...
  $.get('http://jx.xuzhixiang.top/ap/api/bannerlist.php', {
    ...
    for (var k in data.data) {
      var a = data.data[k];
      str += " <div class=\"swiper-slide\" style=\"background-image:url(./images/nature-1.jpg)\"><img src=\"".concat(a.banner_img_url, "\"></div>\n            ");
    }
  ...
  $.get('http://jx.xuzhixiang.top/ap/api/allproductlist.php?pagesize=20&pagenum=4').then(function (data) {
    var str = '';

    for (var k in data.data) {
      var a = data.data[k];
      str += "<li><a href=\"#\"></a>\n            <img src=\"".concat(a.pimg, "\">\n            <p>").concat(a.pname, "</p>\n            <p>").concat(a.pdesc, "</p>\n            <p>\uFFE5").concat(a.pprice, "</p>\n            </li>");
    }
